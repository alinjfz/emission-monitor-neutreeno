...
export function AppHeader() {
  ...
  return (
    <header className="sticky top-0 z-40 h-16 border-b bg-white/95 backdrop-blur">
      ...
      <Dialog
        open={reseedOpen}
        onOpenChange={(open) => !reseeding && setReseedOpen(open)}
      >
        <DialogContent
        ...
        >
          <DialogHeader>
            ...
            <DialogDescription>
              This permanently removes all users, sessions, review history, and
              submission changes, then recreates the original demo data. You
              will be signed out.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
